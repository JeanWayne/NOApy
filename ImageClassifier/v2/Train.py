...
#TODO: Decide if Feature Extractor or Transfere Learning is better.
...
data_dir = '/home/jean/Image_class_v2'
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            if phase == 'train':
                ...
                model.train(False)  # Set model to eval
...
# Observe that _all_ parameters are being optimized
